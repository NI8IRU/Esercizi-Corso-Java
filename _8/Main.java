...
public class Main {
    ...
    private static void exercise3() {
        ...
        String booleanStrToConvert = "maybe"; // And this line    // Appunto: non è stato necessario
        System.out.println(Boolean.valueOf(booleanStrToConvert)); // cambiare nulla in questa stringa(58),
                                                                  // Intellij compila senza dare errori
    ...
    private static void exercise4() {
        ...
        int num = Integer.valueOf(startStr);
        num *= 2;
        startStr = String.valueOf(num);
        startStr += startStr;
        double num2 = Double.valueOf(startStr);
        num2 /= 3.5;
