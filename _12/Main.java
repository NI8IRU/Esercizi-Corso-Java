...
public class Main {
    ...
    public static double exercise1(String text, double expectedScore) {
        ...
        if (text.contains("a")) yourScore -= 5;
        if (text.equals(text.toLowerCase())) yourScore += 10;
        if (yourScore > 20) yourScore *= 2;
        // End it here
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        // Start your code here
        if (mealType.equals("sandwich")) yourMealScore = weight * 5;
        if (mealType.equals("soup")) yourMealScore = weight * 3;
