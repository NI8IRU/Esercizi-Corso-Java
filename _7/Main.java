...
public class Main {
    ...
    private static void exercise2() {
        ...
        String middleName = "FrA";
        String lastName = "TorNaMbè";
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        String textFrom2Primitives = "Str" + "ing"; // <--- Edit this line
        System.out.println(textFrom2Primitives);
        // La variabile textFrom2Primitives ha bisono di dati di tipo "String" per funzionare correttamente
    }
