...
public class Main {
    ...
    private static void exercise4Bonus() {
        ...
        // Ritorna l'intero più vicino ad infinito negativo che sia >= di "ourValue"
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));
        // Ritorna l'intero più vicino ad infinito positivo che sia <= di "ourValue"
        System.out.println(ourValue + " after using floor=" + Math.floor(ourValue));
        // Ritorna l'intero più vicino ad "ourValue" e come seconda condizione che sia più vicino possibile
        // ad infinito positivo: round(5.5)=6, round(-5.5)=-5
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // Ritorna il quadrato di "ourValue"
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2));
        // Ritorna il cubo di "ourValue"
        System.out.println(ourValue + " after using powerOf with the value of 3=" + Math.pow(ourValue, 3));
        // Moltiplica "ourValue" con un valore randomico che va da 0 a 0.999... (utile per generare numeri
        // casuali in un range prescelto, es: "Math.round(Math.random() * 10)" genera casualmente un numero
        // tra 0 e 10
